    ...
    <body>
        ...
        <div class="container">
            <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 form-container">
                ...
                <?php } ?>
                <form class="form row" method="post" id="signup">
                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            <input type="text" class="form-control" placeholder="First Name" required name="first_name" id="first_name" value="<?php echo (!empty($user_data)) ? $user_data['first_name'] : '' ?>">
                        </div>
                    </div>
                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                        <div class="input-group">
                    ...
                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Landline No." name="landline_no" id="landline_no" autofocus value="<?php echo (!empty($user_data)) ? $user_data['landline_no'] : '' ?>">
                        </div>
                    </div>
                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                        <div class="input-group">
